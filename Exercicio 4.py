...
def curtir_publicacao():
    ...
    def visualizar_publicacoes_por_autor():
        ...
        if not lista_publicações:
            print("Nenhuma publicação disponível.")
            return
        
        autor = input("Digíte o nome do autor: ")
        ...
        for pub in publicacoes_autor:
            ...
            print(+" {pub.data_hora.strftime('%d/%m/%Y %H:%M')}")
            print("- * 30")
...
def menu():
    while True:
        ...
        print("4. Visualizar Publiacações Individual")
        print("5. Visualizar Publiacações poe Autor")
        print("0. Sair")
